...
public class Constants {
	...
	public final static double DISTANCE_PER_ROT = 6 * Math.PI; // 6 pi for
																// prototype
	...
	// public final static int ULTRA_GAP = 1; // Distance between the two
	// ultrasonic sensors in inches// needs to be measured and put in

	public final static int SHOOT_DISTANCE = 0; // The set distance we want it
												// to shoot at
}
